...
export default function RepositoryBrowser() {
  ...
  async function fetchContents() {
    ...
    try {
      ...
      if (isLocal) {
        url = `/api/projects/local/contents?project_id=${projectId}&path=${currentPath}`;
      } else {
  ...
  async function handleFileClick(item: FileItem) {
    if (item.type === 'file') {
      ...
      try {
        ...
        if (isLocal) {
          url = `/api/projects/local/file?project_id=${projectId}&path=${item.path}`;
        } else {
  ...
  if ((!isLocal && (!owner || !repo)) || (isLocal && !projectId)) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-4">No project selected</p>
            ...
            <div className="flex items-center space-x-3">
              ...
              {!isLocal && (
                <button
                  ...
                  disabled={refreshing}
                  className="flex items-center space-x-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#1a1a1a] rounded-lg transition disabled:opacity-50"
                >
                  <svg
                  ...
                  {currentPath && (
                    <>
                      <Link
                        ...
                        className="flex items-center space-x-3 p-4 hover:bg-gray-50 dark:hover:bg-[#1a1a1a] transition border-l-4 border-l-transparent"
                      >
                        <svg
                      ...
                      <div className="border-b border-gray-200 dark:border-[#1f1f1f]"></div>
                    </>
                  )}
                      ...
                      <div
                        ...
                        className={`flex items-center justify-between p-4 cursor-pointer transition ${
                          selectedFile === item.path 
                            ...
                            : 'hover:bg-gray-50 dark:hover:bg-[#1a1a1a] border-l-4 border-l-transparent'
                        }`}
                      >
